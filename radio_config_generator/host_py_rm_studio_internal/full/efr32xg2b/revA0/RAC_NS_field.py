...
class RM_Field_RAC_NS_CTRL_RFECAFEATURESEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_CTRL_RFECAFEATURESEL, self).__init__(register,
            'RFECAFEATURESEL', 'RAC_NS.CTRL.RFECAFEATURESEL', 'read-write',
            u"",
            29, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_RX_IFADCS2PRSTN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_RX_IFADCS2PRSTN, self).__init__(register,
            'IFADCS2PRSTN', 'RAC_NS.RX.IFADCS2PRSTN', 'read-write',
            u"",
            12, 1)
        self.__dict__['zz_frozen'] = True
