...
Prints joystick position at intervals over VCOM using Micrium OS. View output in a terminal. Requires Wireless Pro Kit (BRD4002A) as mainboard.
...
This example demonstrates the Joystick driver in a Micrium OS kernel task. It reads the joystick position at regular intervals and prints the values over VCOM. You can view the output in a terminal. Requires the Wireless Pro Kit (BRD4002A) as the mainboard with a compatible radio board that has a joystick.
