/***************************************************************************//**
 * @file
 * @brief Bluetooth Peer Manager - peripheral config
 *******************************************************************************
 * # License
 ...
 *
 ******************************************************************************/
#ifndef SL_BT_PEER_MANAGER_PERIPHERAL_CONFIG_H
#define SL_BT_PEER_MANAGER_PERIPHERAL_CONFIG_H
...
#if defined(SL_CATALOG_BLE_PEER_MANAGER_PERIPHERAL_PRESENT)
#include "ble_peer_manager_peripheral_config_compat.h"
#endif

// <<< Use Configuration Wizard in Context Menu >>>

// <q SL_BT_PEER_MANAGER_PERIPHERAL_CONFIG_DEFAULT_ADV_DISCOVERY_MODE> Advertising discovery mode
...
#define SL_BT_PEER_MANAGER_PERIPHERAL_CONFIG_DEFAULT_ADV_DISCOVERY_MODE         sl_bt_advertiser_general_discoverable
#endif

// <q SL_BT_PEER_MANAGER_PERIPHERAL_CONFIG_DEFAULT_ADV_CONNECTION_MODE> Advertiser connection mode
...
#define SL_BT_PEER_MANAGER_PERIPHERAL_CONFIG_DEFAULT_ADV_CONNECTION_MODE        sl_bt_legacy_advertiser_connectable
#endif

// <o SL_BT_PEER_MANAGER_PERIPHERAL_CONFIG_ADV_TIMING_INTERVAL_MIN> Minimum advertising interval <32..16777>
...
#define SL_BT_PEER_MANAGER_PERIPHERAL_CONFIG_ADV_TIMING_INTERVAL_MIN            160
#endif

// <o SL_BT_PEER_MANAGER_PERIPHERAL_CONFIG_ADV_TIMING_INTERVAL_MAX> Maximum advertising interval <32..16777>
// <i> Value in units of 0.625 ms
// <i> Range: 0x20 to 0xFFFFFF
// <i> Time range: 20 ms to 10485.759375 s
// <i> Default value: 100 ms
#ifndef SL_BT_PEER_MANAGER_PERIPHERAL_CONFIG_ADV_TIMING_INTERVAL_MAX
#define SL_BT_PEER_MANAGER_PERIPHERAL_CONFIG_ADV_TIMING_INTERVAL_MAX            160
#endif

// <o SL_BT_PEER_MANAGER_PERIPHERAL_CONFIG_ADV_TIMING_DURATION> Advertising duration <0..65535>
...
#define SL_BT_PEER_MANAGER_PERIPHERAL_CONFIG_ADV_TIMING_DURATION                0
#endif

// <o SL_BT_PEER_MANAGER_PERIPHERAL_CONFIG_ADV_TIMING_MAX_EVENTS> Maximum number of advertising events <0..100>
...
#define SL_BT_PEER_MANAGER_PERIPHERAL_CONFIG_ADV_TIMING_MAX_EVENTS              0
#endif

// <q SL_BT_PEER_MANAGER_PERIPHERAL_CONFIG_ADV_PHY> Advertiser PHY
// <sl_bt_gap_phy_1m=> 1Mbps PHY
// <sl_bt_gap_phy_2m=> 2Mbps PHY
// <i> Default: 1Mbps PHY
#ifndef SL_BT_PEER_MANAGER_PERIPHERAL_CONFIG_ADV_PHY
#define SL_BT_PEER_MANAGER_PERIPHERAL_CONFIG_ADV_PHY                            sl_bt_gap_phy_1m
#endif

// <<< end of configuration section >>>

/** @} (end addtogroup sl_bt_peer_manager_peripheral) */
#endif // SL_BT_PEER_MANAGER_PERIPHERAL_CONFIG_H
