...
class RM_Register_RAC_NS_CTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.RFECAFEATURESEL = RM_Field_RAC_NS_CTRL_RFECAFEATURESEL(self)
        self.zz_fdict['RFECAFEATURESEL'] = self.RFECAFEATURESEL
        self.__dict__['zz_frozen'] = True
...
class RM_Register_RAC_NS_RX(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.IFADCS2PRSTN = RM_Field_RAC_NS_RX_IFADCS2PRSTN(self)
