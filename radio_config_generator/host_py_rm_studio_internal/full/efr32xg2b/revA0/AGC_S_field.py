...
class RM_Field_AGC_S_CTRL5_FRAMERSSIEARLY(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_S_CTRL5_FRAMERSSIEARLY, self).__init__(register,
            'FRAMERSSIEARLY', 'AGC_S.CTRL5.FRAMERSSIEARLY', 'read-write',
            u"",
            24, 1)
        self.__dict__['zz_frozen'] = True
