...
This example demonstrates the internal temperature sensor driver in a Micrium OS kernel task. Temperature limits and LED feedback are shown; status is printed on VCOM.
...
3. Run the application. Observe LED behavior and/or VCOM output as temperature changes.
...
- **Build errors:** Verify target part has an internal temperature sensor and that TEMPDRV and Micrium OS are configured.
