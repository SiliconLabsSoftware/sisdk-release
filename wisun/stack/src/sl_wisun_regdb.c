...
const sl_wisun_chan_params_t chan_params_table[] = {
  ...
  *      regulatory_domain        |     regional_regulation        | chan0_freq_hz      |    |       valid phy_mode_ids         chan_allowed */
  ...
  { SL_WISUN_REGULATORY_DOMAIN_BZ, 0, SL_WISUN_REGULATION_NONE,     4,  902800000,  800000,  32, { 51, 52, 53, 54,             }, "0-4,17-30", },
  { SL_WISUN_REGULATORY_DOMAIN_BZ, 0, SL_WISUN_REGULATION_NONE,     5,  903200000, 1200000,  21, { 34, 35, 36, 37, 38,         }, "0-2,11-19", },
