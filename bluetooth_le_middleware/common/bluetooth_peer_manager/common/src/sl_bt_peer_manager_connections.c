...
static sli_bt_peer_manager_connection_t pm_connections[SL_BT_PEER_MANAGER_COMMON_MAX_ALLOWED_CONN_COUNT];
...
{
  for (uint8_t i = 0; i < SL_BT_PEER_MANAGER_COMMON_MAX_ALLOWED_CONN_COUNT; i++) {
