...
class CalcFrcMisc(IPCalculator):
    ...
    def calc_frc_new_bf(self, model):
        ...
        self._ip_reg_write_default(model, 'TRAILRXDATA_HDTRXSTATUS')

        self._ip_reg_write_default(model, 'HWCTRL_RXABORTWAITEOFEN')
        self._ip_reg_write_default(model, 'HWCTRL_HDTWAITEOFEN')
        self._ip_reg_write_default(model, 'HWCTRL_RXABORTTRAILEN')
        self._ip_reg_write_default(model, 'HWCTRL_RXABORTSUPEN')
