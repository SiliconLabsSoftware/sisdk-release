 ...
 *
 ******************************************************************************/
#ifndef SL_BT_PEER_MANAGER_CENTRAL_H
#define SL_BT_PEER_MANAGER_CENTRAL_H
 ...
 * @retval SL_STATUS_OK if successful otherwise error code.
 *****************************************************************************/
sl_status_t sl_bt_peer_manager_central_open_connection(bd_addr *address,
...
#endif // SL_BT_PEER_MANAGER_CENTRAL_H
