 ...
 *
 ******************************************************************************/
#ifndef SL_BT_PEER_MANAGER_FILTER_H
#define SL_BT_PEER_MANAGER_FILTER_H
 ...
 * @retval SL_STATUS_INVALID_STATE if scanning is active
 *****************************************************************************/
sl_status_t sl_bt_peer_manager_set_filter_address_type(sl_bt_gap_address_type_t filter_addr_type);
 ...
 *
 * @param[in] str Hexadecimal representation of the Bluetooth LE address with
 *                optional separator characters ':' or ' ',
...
#endif // SL_BT_PEER_MANAGER_FILTER_H
