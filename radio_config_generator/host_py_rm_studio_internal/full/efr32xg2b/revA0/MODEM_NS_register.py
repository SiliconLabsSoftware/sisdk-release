...
class RM_Register_MODEM_NS_CTRL3(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.DEVZEROTRAILTX = RM_Field_MODEM_NS_CTRL3_DEVZEROTRAILTX(self)
        self.zz_fdict['DEVZEROTRAILTX'] = self.DEVZEROTRAILTX
...
class RM_Register_MODEM_NS_DCCOMP(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.DCCOMPZIFRSTEN = RM_Field_MODEM_NS_DCCOMP_DCCOMPZIFRSTEN(self)
        self.zz_fdict['DCCOMPZIFRSTEN'] = self.DCCOMPZIFRSTEN
        self.__dict__['zz_frozen'] = True
...
class RM_Register_MODEM_NS_SRCCHF(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.MUFIFOSEL = RM_Field_MODEM_NS_SRCCHF_MUFIFOSEL(self)
        self.zz_fdict['MUFIFOSEL'] = self.MUFIFOSEL
...
class RM_Register_MODEM_NS_IRCALCOEFWR(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_NS_IRCALCOEFWR, self).__init__(rmio, label,
            0xb8014000, 0x28C,
            'IRCALCOEFWR', 'MODEM_NS.IRCALCOEFWR', 'read-write',
            u"",
            0x00000000, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.CRVWD = RM_Field_MODEM_NS_IRCALCOEFWR_CRVWD(self)
        self.zz_fdict['CRVWD'] = self.CRVWD
        self.CRVWEN = RM_Field_MODEM_NS_IRCALCOEFWR_CRVWEN(self)
        self.zz_fdict['CRVWEN'] = self.CRVWEN
        self.CIVWD = RM_Field_MODEM_NS_IRCALCOEFWR_CIVWD(self)
        self.zz_fdict['CIVWD'] = self.CIVWD
        self.CIVWEN = RM_Field_MODEM_NS_IRCALCOEFWR_CIVWEN(self)
...
class RM_Register_MODEM_NS_CHFCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.CHFSWTIME = RM_Field_MODEM_NS_CHFCTRL_CHFSWTIME(self)
        self.zz_fdict['CHFSWTIME'] = self.CHFSWTIME
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_NS_CHFCSDCOE00(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_NS_CHFCSDCOE00, self).__init__(rmio, label,
            0xb8014000, 0x294,
            'CHFCSDCOE00', 'MODEM_NS.CHFCSDCOE00', 'read-write',
            u"",
            0x00000000, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SET0CSDCOEFF0 = RM_Field_MODEM_NS_CHFCSDCOE00_SET0CSDCOEFF0(self)
        self.zz_fdict['SET0CSDCOEFF0'] = self.SET0CSDCOEFF0
        self.SET0CSDCOEFF1 = RM_Field_MODEM_NS_CHFCSDCOE00_SET0CSDCOEFF1(self)
        self.zz_fdict['SET0CSDCOEFF1'] = self.SET0CSDCOEFF1
        self.SET0CSDCOEFF2 = RM_Field_MODEM_NS_CHFCSDCOE00_SET0CSDCOEFF2(self)
        self.zz_fdict['SET0CSDCOEFF2'] = self.SET0CSDCOEFF2
        self.SET0CSDCOEFF3 = RM_Field_MODEM_NS_CHFCSDCOE00_SET0CSDCOEFF3(self)
        self.zz_fdict['SET0CSDCOEFF3'] = self.SET0CSDCOEFF3
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_NS_CHFCSDCOE01(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_NS_CHFCSDCOE01, self).__init__(rmio, label,
            0xb8014000, 0x298,
            'CHFCSDCOE01', 'MODEM_NS.CHFCSDCOE01', 'read-write',
            u"",
            0x00000000, 0x07FFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SET0CSDCOEFF4 = RM_Field_MODEM_NS_CHFCSDCOE01_SET0CSDCOEFF4(self)
        self.zz_fdict['SET0CSDCOEFF4'] = self.SET0CSDCOEFF4
        self.SET0CSDCOEFF5 = RM_Field_MODEM_NS_CHFCSDCOE01_SET0CSDCOEFF5(self)
        self.zz_fdict['SET0CSDCOEFF5'] = self.SET0CSDCOEFF5
        self.SET0CSDCOEFF6 = RM_Field_MODEM_NS_CHFCSDCOE01_SET0CSDCOEFF6(self)
        self.zz_fdict['SET0CSDCOEFF6'] = self.SET0CSDCOEFF6
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_NS_CHFCSDCOE02(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_NS_CHFCSDCOE02, self).__init__(rmio, label,
            0xb8014000, 0x29C,
            'CHFCSDCOE02', 'MODEM_NS.CHFCSDCOE02', 'read-write',
            u"",
            0x00000000, 0x7FFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SET0CSDCOEFF7 = RM_Field_MODEM_NS_CHFCSDCOE02_SET0CSDCOEFF7(self)
        self.zz_fdict['SET0CSDCOEFF7'] = self.SET0CSDCOEFF7
        self.SET0CSDCOEFF8 = RM_Field_MODEM_NS_CHFCSDCOE02_SET0CSDCOEFF8(self)
        self.zz_fdict['SET0CSDCOEFF8'] = self.SET0CSDCOEFF8
        self.SET0CSDCOEFF9 = RM_Field_MODEM_NS_CHFCSDCOE02_SET0CSDCOEFF9(self)
        self.zz_fdict['SET0CSDCOEFF9'] = self.SET0CSDCOEFF9
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_NS_CHFCSDCOE03(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_NS_CHFCSDCOE03, self).__init__(rmio, label,
            0xb8014000, 0x2A0,
            'CHFCSDCOE03', 'MODEM_NS.CHFCSDCOE03', 'read-write',
            u"",
            0x00000000, 0x00FFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SET0CSDCOEFF10 = RM_Field_MODEM_NS_CHFCSDCOE03_SET0CSDCOEFF10(self)
        self.zz_fdict['SET0CSDCOEFF10'] = self.SET0CSDCOEFF10
        self.SET0CSDCOEFF11 = RM_Field_MODEM_NS_CHFCSDCOE03_SET0CSDCOEFF11(self)
        self.zz_fdict['SET0CSDCOEFF11'] = self.SET0CSDCOEFF11
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_NS_CHFCSDCOE10(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_NS_CHFCSDCOE10, self).__init__(rmio, label,
            0xb8014000, 0x2A4,
            'CHFCSDCOE10', 'MODEM_NS.CHFCSDCOE10', 'read-write',
            u"",
            0x00000000, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SET1CSDCOEFF0 = RM_Field_MODEM_NS_CHFCSDCOE10_SET1CSDCOEFF0(self)
        self.zz_fdict['SET1CSDCOEFF0'] = self.SET1CSDCOEFF0
        self.SET1CSDCOEFF1 = RM_Field_MODEM_NS_CHFCSDCOE10_SET1CSDCOEFF1(self)
        self.zz_fdict['SET1CSDCOEFF1'] = self.SET1CSDCOEFF1
        self.SET1CSDCOEFF2 = RM_Field_MODEM_NS_CHFCSDCOE10_SET1CSDCOEFF2(self)
        self.zz_fdict['SET1CSDCOEFF2'] = self.SET1CSDCOEFF2
        self.SET1CSDCOEFF3 = RM_Field_MODEM_NS_CHFCSDCOE10_SET1CSDCOEFF3(self)
        self.zz_fdict['SET1CSDCOEFF3'] = self.SET1CSDCOEFF3
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_NS_CHFCSDCOE11(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_NS_CHFCSDCOE11, self).__init__(rmio, label,
            0xb8014000, 0x2A8,
            'CHFCSDCOE11', 'MODEM_NS.CHFCSDCOE11', 'read-write',
            u"",
            0x00000000, 0x07FFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SET1CSDCOEFF4 = RM_Field_MODEM_NS_CHFCSDCOE11_SET1CSDCOEFF4(self)
        self.zz_fdict['SET1CSDCOEFF4'] = self.SET1CSDCOEFF4
        self.SET1CSDCOEFF5 = RM_Field_MODEM_NS_CHFCSDCOE11_SET1CSDCOEFF5(self)
        self.zz_fdict['SET1CSDCOEFF5'] = self.SET1CSDCOEFF5
        self.SET1CSDCOEFF6 = RM_Field_MODEM_NS_CHFCSDCOE11_SET1CSDCOEFF6(self)
        self.zz_fdict['SET1CSDCOEFF6'] = self.SET1CSDCOEFF6
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_NS_CHFCSDCOE12(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_NS_CHFCSDCOE12, self).__init__(rmio, label,
            0xb8014000, 0x2AC,
            'CHFCSDCOE12', 'MODEM_NS.CHFCSDCOE12', 'read-write',
            u"",
            0x00000000, 0x7FFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SET1CSDCOEFF7 = RM_Field_MODEM_NS_CHFCSDCOE12_SET1CSDCOEFF7(self)
        self.zz_fdict['SET1CSDCOEFF7'] = self.SET1CSDCOEFF7
        self.SET1CSDCOEFF8 = RM_Field_MODEM_NS_CHFCSDCOE12_SET1CSDCOEFF8(self)
        self.zz_fdict['SET1CSDCOEFF8'] = self.SET1CSDCOEFF8
        self.SET1CSDCOEFF9 = RM_Field_MODEM_NS_CHFCSDCOE12_SET1CSDCOEFF9(self)
        self.zz_fdict['SET1CSDCOEFF9'] = self.SET1CSDCOEFF9
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_NS_CHFCSDCOE13(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_NS_CHFCSDCOE13, self).__init__(rmio, label,
            0xb8014000, 0x2B0,
            'CHFCSDCOE13', 'MODEM_NS.CHFCSDCOE13', 'read-write',
            u"",
            0x00000000, 0x00FFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SET1CSDCOEFF10 = RM_Field_MODEM_NS_CHFCSDCOE13_SET1CSDCOEFF10(self)
        self.zz_fdict['SET1CSDCOEFF10'] = self.SET1CSDCOEFF10
        self.SET1CSDCOEFF11 = RM_Field_MODEM_NS_CHFCSDCOE13_SET1CSDCOEFF11(self)
        self.zz_fdict['SET1CSDCOEFF11'] = self.SET1CSDCOEFF11
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_NS_CHFCSDCOE00S(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_NS_CHFCSDCOE00S, self).__init__(rmio, label,
            0xb8014000, 0x2B4,
            'CHFCSDCOE00S', 'MODEM_NS.CHFCSDCOE00S', 'read-write',
            u"",
            0x00000000, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SET0CSDCOEFF0S = RM_Field_MODEM_NS_CHFCSDCOE00S_SET0CSDCOEFF0S(self)
        self.zz_fdict['SET0CSDCOEFF0S'] = self.SET0CSDCOEFF0S
        self.SET0CSDCOEFF1S = RM_Field_MODEM_NS_CHFCSDCOE00S_SET0CSDCOEFF1S(self)
        self.zz_fdict['SET0CSDCOEFF1S'] = self.SET0CSDCOEFF1S
        self.SET0CSDCOEFF2S = RM_Field_MODEM_NS_CHFCSDCOE00S_SET0CSDCOEFF2S(self)
        self.zz_fdict['SET0CSDCOEFF2S'] = self.SET0CSDCOEFF2S
        self.SET0CSDCOEFF3S = RM_Field_MODEM_NS_CHFCSDCOE00S_SET0CSDCOEFF3S(self)
        self.zz_fdict['SET0CSDCOEFF3S'] = self.SET0CSDCOEFF3S
        self.SET0CSDCOEFF4S = RM_Field_MODEM_NS_CHFCSDCOE00S_SET0CSDCOEFF4S(self)
        self.zz_fdict['SET0CSDCOEFF4S'] = self.SET0CSDCOEFF4S
        self.SET0CSDCOEFF5S = RM_Field_MODEM_NS_CHFCSDCOE00S_SET0CSDCOEFF5S(self)
        self.zz_fdict['SET0CSDCOEFF5S'] = self.SET0CSDCOEFF5S
        self.SET0CSDCOEFF6S = RM_Field_MODEM_NS_CHFCSDCOE00S_SET0CSDCOEFF6S(self)
        self.zz_fdict['SET0CSDCOEFF6S'] = self.SET0CSDCOEFF6S
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_NS_CHFCSDCOE01S(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_NS_CHFCSDCOE01S, self).__init__(rmio, label,
            0xb8014000, 0x2B8,
            'CHFCSDCOE01S', 'MODEM_NS.CHFCSDCOE01S', 'read-write',
            u"",
            0x00000000, 0x0FFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SET0CSDCOEFF7S = RM_Field_MODEM_NS_CHFCSDCOE01S_SET0CSDCOEFF7S(self)
        self.zz_fdict['SET0CSDCOEFF7S'] = self.SET0CSDCOEFF7S
        self.SET0CSDCOEFF8S = RM_Field_MODEM_NS_CHFCSDCOE01S_SET0CSDCOEFF8S(self)
        self.zz_fdict['SET0CSDCOEFF8S'] = self.SET0CSDCOEFF8S
        self.SET0CSDCOEFF9S = RM_Field_MODEM_NS_CHFCSDCOE01S_SET0CSDCOEFF9S(self)
        self.zz_fdict['SET0CSDCOEFF9S'] = self.SET0CSDCOEFF9S
        self.SET0CSDCOEFF10S = RM_Field_MODEM_NS_CHFCSDCOE01S_SET0CSDCOEFF10S(self)
        self.zz_fdict['SET0CSDCOEFF10S'] = self.SET0CSDCOEFF10S
        self.SET0CSDCOEFF11S = RM_Field_MODEM_NS_CHFCSDCOE01S_SET0CSDCOEFF11S(self)
        self.zz_fdict['SET0CSDCOEFF11S'] = self.SET0CSDCOEFF11S
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_NS_CHFCSDCOE10S(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_NS_CHFCSDCOE10S, self).__init__(rmio, label,
            0xb8014000, 0x2BC,
            'CHFCSDCOE10S', 'MODEM_NS.CHFCSDCOE10S', 'read-write',
            u"",
            0x00000000, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SET1CSDCOEFF0S = RM_Field_MODEM_NS_CHFCSDCOE10S_SET1CSDCOEFF0S(self)
        self.zz_fdict['SET1CSDCOEFF0S'] = self.SET1CSDCOEFF0S
        self.SET1CSDCOEFF1S = RM_Field_MODEM_NS_CHFCSDCOE10S_SET1CSDCOEFF1S(self)
        self.zz_fdict['SET1CSDCOEFF1S'] = self.SET1CSDCOEFF1S
        self.SET1CSDCOEFF2S = RM_Field_MODEM_NS_CHFCSDCOE10S_SET1CSDCOEFF2S(self)
        self.zz_fdict['SET1CSDCOEFF2S'] = self.SET1CSDCOEFF2S
        self.SET1CSDCOEFF3S = RM_Field_MODEM_NS_CHFCSDCOE10S_SET1CSDCOEFF3S(self)
        self.zz_fdict['SET1CSDCOEFF3S'] = self.SET1CSDCOEFF3S
        self.SET1CSDCOEFF4S = RM_Field_MODEM_NS_CHFCSDCOE10S_SET1CSDCOEFF4S(self)
        self.zz_fdict['SET1CSDCOEFF4S'] = self.SET1CSDCOEFF4S
        self.SET1CSDCOEFF5S = RM_Field_MODEM_NS_CHFCSDCOE10S_SET1CSDCOEFF5S(self)
        self.zz_fdict['SET1CSDCOEFF5S'] = self.SET1CSDCOEFF5S
        self.SET1CSDCOEFF6S = RM_Field_MODEM_NS_CHFCSDCOE10S_SET1CSDCOEFF6S(self)
        self.zz_fdict['SET1CSDCOEFF6S'] = self.SET1CSDCOEFF6S
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_NS_CHFCSDCOE11S(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_NS_CHFCSDCOE11S, self).__init__(rmio, label,
            0xb8014000, 0x2C0,
            'CHFCSDCOE11S', 'MODEM_NS.CHFCSDCOE11S', 'read-write',
            u"",
            0x00000000, 0x0FFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SET1CSDCOEFF7S = RM_Field_MODEM_NS_CHFCSDCOE11S_SET1CSDCOEFF7S(self)
        self.zz_fdict['SET1CSDCOEFF7S'] = self.SET1CSDCOEFF7S
        self.SET1CSDCOEFF8S = RM_Field_MODEM_NS_CHFCSDCOE11S_SET1CSDCOEFF8S(self)
        self.zz_fdict['SET1CSDCOEFF8S'] = self.SET1CSDCOEFF8S
        self.SET1CSDCOEFF9S = RM_Field_MODEM_NS_CHFCSDCOE11S_SET1CSDCOEFF9S(self)
        self.zz_fdict['SET1CSDCOEFF9S'] = self.SET1CSDCOEFF9S
        self.SET1CSDCOEFF10S = RM_Field_MODEM_NS_CHFCSDCOE11S_SET1CSDCOEFF10S(self)
        self.zz_fdict['SET1CSDCOEFF10S'] = self.SET1CSDCOEFF10S
        self.SET1CSDCOEFF11S = RM_Field_MODEM_NS_CHFCSDCOE11S_SET1CSDCOEFF11S(self)
        self.zz_fdict['SET1CSDCOEFF11S'] = self.SET1CSDCOEFF11S
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_NS_CHFCSDCOE00NADM(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_NS_CHFCSDCOE00NADM, self).__init__(rmio, label,
            0xb8014000, 0x2C4,
            'CHFCSDCOE00NADM', 'MODEM_NS.CHFCSDCOE00NADM', 'read-write',
            u"",
            0x00000000, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.NADMCSDCOEFF0 = RM_Field_MODEM_NS_CHFCSDCOE00NADM_NADMCSDCOEFF0(self)
        self.zz_fdict['NADMCSDCOEFF0'] = self.NADMCSDCOEFF0
        self.NADMCSDCOEFF1 = RM_Field_MODEM_NS_CHFCSDCOE00NADM_NADMCSDCOEFF1(self)
        self.zz_fdict['NADMCSDCOEFF1'] = self.NADMCSDCOEFF1
        self.NADMCSDCOEFF2 = RM_Field_MODEM_NS_CHFCSDCOE00NADM_NADMCSDCOEFF2(self)
        self.zz_fdict['NADMCSDCOEFF2'] = self.NADMCSDCOEFF2
        self.NADMCSDCOEFF3 = RM_Field_MODEM_NS_CHFCSDCOE00NADM_NADMCSDCOEFF3(self)
        self.zz_fdict['NADMCSDCOEFF3'] = self.NADMCSDCOEFF3
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_NS_CHFCSDCOE01NADM(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_NS_CHFCSDCOE01NADM, self).__init__(rmio, label,
            0xb8014000, 0x2C8,
            'CHFCSDCOE01NADM', 'MODEM_NS.CHFCSDCOE01NADM', 'read-write',
            u"",
            0x00000000, 0x07FFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.NADMCSDCOEFF4 = RM_Field_MODEM_NS_CHFCSDCOE01NADM_NADMCSDCOEFF4(self)
        self.zz_fdict['NADMCSDCOEFF4'] = self.NADMCSDCOEFF4
        self.NADMCSDCOEFF5 = RM_Field_MODEM_NS_CHFCSDCOE01NADM_NADMCSDCOEFF5(self)
        self.zz_fdict['NADMCSDCOEFF5'] = self.NADMCSDCOEFF5
        self.NADMCSDCOEFF6 = RM_Field_MODEM_NS_CHFCSDCOE01NADM_NADMCSDCOEFF6(self)
        self.zz_fdict['NADMCSDCOEFF6'] = self.NADMCSDCOEFF6
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_NS_CHFCSDCOE02NADM(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_NS_CHFCSDCOE02NADM, self).__init__(rmio, label,
            0xb8014000, 0x2CC,
            'CHFCSDCOE02NADM', 'MODEM_NS.CHFCSDCOE02NADM', 'read-write',
            u"",
            0x00000000, 0x7FFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.NADMCSDCOEFF7 = RM_Field_MODEM_NS_CHFCSDCOE02NADM_NADMCSDCOEFF7(self)
        self.zz_fdict['NADMCSDCOEFF7'] = self.NADMCSDCOEFF7
        self.NADMCSDCOEFF8 = RM_Field_MODEM_NS_CHFCSDCOE02NADM_NADMCSDCOEFF8(self)
        self.zz_fdict['NADMCSDCOEFF8'] = self.NADMCSDCOEFF8
        self.NADMCSDCOEFF9 = RM_Field_MODEM_NS_CHFCSDCOE02NADM_NADMCSDCOEFF9(self)
        self.zz_fdict['NADMCSDCOEFF9'] = self.NADMCSDCOEFF9
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_NS_CHFCSDCOE03NADM(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_NS_CHFCSDCOE03NADM, self).__init__(rmio, label,
            0xb8014000, 0x2D0,
            'CHFCSDCOE03NADM', 'MODEM_NS.CHFCSDCOE03NADM', 'read-write',
            u"",
            0x00000000, 0x00FFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.NADMCSDCOEFF10 = RM_Field_MODEM_NS_CHFCSDCOE03NADM_NADMCSDCOEFF10(self)
        self.zz_fdict['NADMCSDCOEFF10'] = self.NADMCSDCOEFF10
        self.NADMCSDCOEFF11 = RM_Field_MODEM_NS_CHFCSDCOE03NADM_NADMCSDCOEFF11(self)
        self.zz_fdict['NADMCSDCOEFF11'] = self.NADMCSDCOEFF11
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_NS_CHFCSDCOE00SNADM(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_NS_CHFCSDCOE00SNADM, self).__init__(rmio, label,
            0xb8014000, 0x2D4,
            'CHFCSDCOE00SNADM', 'MODEM_NS.CHFCSDCOE00SNADM', 'read-write',
            u"",
            0x00000000, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.NADMCSDCOEFF0S = RM_Field_MODEM_NS_CHFCSDCOE00SNADM_NADMCSDCOEFF0S(self)
        self.zz_fdict['NADMCSDCOEFF0S'] = self.NADMCSDCOEFF0S
        self.NADMCSDCOEFF1S = RM_Field_MODEM_NS_CHFCSDCOE00SNADM_NADMCSDCOEFF1S(self)
        self.zz_fdict['NADMCSDCOEFF1S'] = self.NADMCSDCOEFF1S
        self.NADMCSDCOEFF2S = RM_Field_MODEM_NS_CHFCSDCOE00SNADM_NADMCSDCOEFF2S(self)
        self.zz_fdict['NADMCSDCOEFF2S'] = self.NADMCSDCOEFF2S
        self.NADMCSDCOEFF3S = RM_Field_MODEM_NS_CHFCSDCOE00SNADM_NADMCSDCOEFF3S(self)
        self.zz_fdict['NADMCSDCOEFF3S'] = self.NADMCSDCOEFF3S
        self.NADMCSDCOEFF4S = RM_Field_MODEM_NS_CHFCSDCOE00SNADM_NADMCSDCOEFF4S(self)
        self.zz_fdict['NADMCSDCOEFF4S'] = self.NADMCSDCOEFF4S
        self.NADMCSDCOEFF5S = RM_Field_MODEM_NS_CHFCSDCOE00SNADM_NADMCSDCOEFF5S(self)
        self.zz_fdict['NADMCSDCOEFF5S'] = self.NADMCSDCOEFF5S
        self.NADMCSDCOEFF6S = RM_Field_MODEM_NS_CHFCSDCOE00SNADM_NADMCSDCOEFF6S(self)
        self.zz_fdict['NADMCSDCOEFF6S'] = self.NADMCSDCOEFF6S
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_NS_CHFCSDCOE01SNADM(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_NS_CHFCSDCOE01SNADM, self).__init__(rmio, label,
            0xb8014000, 0x2D8,
            'CHFCSDCOE01SNADM', 'MODEM_NS.CHFCSDCOE01SNADM', 'read-write',
            u"",
            0x00000000, 0x0FFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.NADMCSDCOEFF7S = RM_Field_MODEM_NS_CHFCSDCOE01SNADM_NADMCSDCOEFF7S(self)
        self.zz_fdict['NADMCSDCOEFF7S'] = self.NADMCSDCOEFF7S
        self.NADMCSDCOEFF8S = RM_Field_MODEM_NS_CHFCSDCOE01SNADM_NADMCSDCOEFF8S(self)
        self.zz_fdict['NADMCSDCOEFF8S'] = self.NADMCSDCOEFF8S
        self.NADMCSDCOEFF9S = RM_Field_MODEM_NS_CHFCSDCOE01SNADM_NADMCSDCOEFF9S(self)
        self.zz_fdict['NADMCSDCOEFF9S'] = self.NADMCSDCOEFF9S
        self.NADMCSDCOEFF10S = RM_Field_MODEM_NS_CHFCSDCOE01SNADM_NADMCSDCOEFF10S(self)
        self.zz_fdict['NADMCSDCOEFF10S'] = self.NADMCSDCOEFF10S
        self.NADMCSDCOEFF11S = RM_Field_MODEM_NS_CHFCSDCOE01SNADM_NADMCSDCOEFF11S(self)
        self.zz_fdict['NADMCSDCOEFF11S'] = self.NADMCSDCOEFF11S
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_NS_UCHDR(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_NS_UCHDR, self).__init__(rmio, label,
            0xb8014000, 0x2DC,
            'UCHDR', 'MODEM_NS.UCHDR', 'read-write',
            u"",
            0x00000000, 0x00003FFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.UCHDREN = RM_Field_MODEM_NS_UCHDR_UCHDREN(self)
        self.zz_fdict['UCHDREN'] = self.UCHDREN
        self.UCHDRBITS = RM_Field_MODEM_NS_UCHDR_UCHDRBITS(self)
        self.zz_fdict['UCHDRBITS'] = self.UCHDRBITS
        self.UCHDRBITSX2 = RM_Field_MODEM_NS_UCHDR_UCHDRBITSX2(self)
        self.zz_fdict['UCHDRBITSX2'] = self.UCHDRBITSX2
        self.UCHDRBAUD = RM_Field_MODEM_NS_UCHDR_UCHDRBAUD(self)
        self.zz_fdict['UCHDRBAUD'] = self.UCHDRBAUD
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_NS_RAMPAUTO(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_NS_RAMPAUTO, self).__init__(rmio, label,
            0xb8014000, 0x2E0,
            'RAMPAUTO', 'MODEM_NS.RAMPAUTO', 'read-write',
            u"",
            0x00000000, 0x000001FF,
            0x00001000, 0x00002000,
            0x00003000)

        self.RAMPDOWNAUTO = RM_Field_MODEM_NS_RAMPAUTO_RAMPDOWNAUTO(self)
        self.zz_fdict['RAMPDOWNAUTO'] = self.RAMPDOWNAUTO
        self.RAMPDOWNTIMER = RM_Field_MODEM_NS_RAMPAUTO_RAMPDOWNTIMER(self)
        self.zz_fdict['RAMPDOWNTIMER'] = self.RAMPDOWNTIMER
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_NS_RAMPHADM(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_NS_RAMPHADM, self).__init__(rmio, label,
            0xb8014000, 0x2E4,
            'RAMPHADM', 'MODEM_NS.RAMPHADM', 'read-write',
            u"",
            0x0000059F, 0x00001FFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.RAMPLEVHADM = RM_Field_MODEM_NS_RAMPHADM_RAMPLEVHADM(self)
        self.zz_fdict['RAMPLEVHADM'] = self.RAMPLEVHADM
        self.RAMPRATEHADM = RM_Field_MODEM_NS_RAMPHADM_RAMPRATEHADM(self)
        self.zz_fdict['RAMPRATEHADM'] = self.RAMPRATEHADM
        self.RAMPENHADM = RM_Field_MODEM_NS_RAMPHADM_RAMPENHADM(self)
        self.zz_fdict['RAMPENHADM'] = self.RAMPENHADM
        self.__dict__['zz_frozen'] = True
