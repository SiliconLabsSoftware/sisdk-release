# I/O Stream USART Bare-metal

Uses the I/O Stream service to demonstrate UART over the kit's virtual COM port (VCOM). Characters you send are echoed back; connect via USB or Ethernet port 4902.
...
This example shows how to use the I/O Stream service in a bare-metal application to send and receive data over UART. The kit appears as a virtual COM port (VCOM). Characters you type in a terminal are echoed back. The demo works over USB or over TCP port 4902 when the kit is connected by Ethernet.
