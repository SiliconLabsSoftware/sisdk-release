...
class RM_Field_SYNTH_S_CTRL_INLINEPCTEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_S_CTRL_INLINEPCTEN, self).__init__(register,
            'INLINEPCTEN', 'SYNTH_S.CTRL.INLINEPCTEN', 'read-write',
            u"",
            26, 1)
        self.__dict__['zz_frozen'] = True
