...
class RM_Field_FRC_NS_AHBCONFIG_AHBHPROTCACHEABLE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_NS_AHBCONFIG_AHBHPROTCACHEABLE, self).__init__(register,
            'AHBHPROTCACHEABLE', 'FRC_NS.AHBCONFIG.AHBHPROTCACHEABLE', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_NS_TRAILTXDATACTRL2_TRAILTXBITSEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_NS_TRAILTXDATACTRL2_TRAILTXBITSEN, self).__init__(register,
            'TRAILTXBITSEN', 'FRC_NS.TRAILTXDATACTRL2.TRAILTXBITSEN', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_NS_TRAILTXDATACTRL2_TRAILTXBITS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_NS_TRAILTXDATACTRL2_TRAILTXBITS, self).__init__(register,
            'TRAILTXBITS', 'FRC_NS.TRAILTXDATACTRL2.TRAILTXBITS', 'read-write',
            u"",
            1, 7)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_NS_TRAILTXDATACTRL2_TRAILTXBITSX2(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_NS_TRAILTXDATACTRL2_TRAILTXBITSX2, self).__init__(register,
            'TRAILTXBITSX2', 'FRC_NS.TRAILTXDATACTRL2.TRAILTXBITSX2', 'read-write',
            u"",
            8, 1)
        self.__dict__['zz_frozen'] = True
