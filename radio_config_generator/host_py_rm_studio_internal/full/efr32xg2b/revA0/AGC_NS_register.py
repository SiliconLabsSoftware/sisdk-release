...
class RM_Register_AGC_NS_CTRL0(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.DISRSSIANTDIVFIX = RM_Field_AGC_NS_CTRL0_DISRSSIANTDIVFIX(self)
...
class RM_Register_AGC_NS_CTRL5(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.FRAMERSSIEARLY = RM_Field_AGC_NS_CTRL5_FRAMERSSIEARLY(self)
        self.zz_fdict['FRAMERSSIEARLY'] = self.FRAMERSSIEARLY
        self.__dict__['zz_frozen'] = True
