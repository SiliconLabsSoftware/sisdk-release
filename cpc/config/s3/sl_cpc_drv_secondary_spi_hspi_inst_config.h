...
// <o SL_CPC_DRV_SPI_INST_RX_QUEUE_SIZE> Number of frame that can be queued in the driver receive queue <1-1024>
...
// <o SL_CPC_DRV_SPI_INST_TX_QUEUE_SIZE> Number of frame that can be queued in the driver transmit queue <1-1024>
