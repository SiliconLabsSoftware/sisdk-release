...
// <<< sl:start pin_tool >>>
// <eusart signal=TX,RX,SCLK,(CS)> LEGACY_NCP_SPI
// $[EUSART_LEGACY_NCP_SPI]
#define LEGACY_NCP_SPI_PERIPHERAL                EUSART1
...
#define LEGACY_NCP_SPI_SCLK_PORT                 SL_GPIO_PORT_C
#define LEGACY_NCP_SPI_SCLK_PIN                  2
