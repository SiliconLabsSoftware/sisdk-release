...
const char *decode_sl_zigbee_ezsp_value_id_t(uint8_t value)
{
  switch (value) {
    ...
    case SL_ZIGBEE_EZSP_CONFIG_SLEEPY_TARGET_MAC_TIMEOUT_INCREASE: return "SL_ZIGBEE_EZSP_CONFIG_SLEEPY_TARGET_MAC_TIMEOUT_INCREASE";
  }
  return "*** Not enumerated. ***";
}
...
// Binding Frames
    ...
    case SL_ZIGBEE_EZSP_CLEAR_BINDING_TABLE_ON_LEAVE: return "SL_ZIGBEE_EZSP_CLEAR_BINDING_TABLE_ON_LEAVE";
