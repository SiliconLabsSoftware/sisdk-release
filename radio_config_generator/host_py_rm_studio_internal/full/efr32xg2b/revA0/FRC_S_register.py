...
class RM_Register_FRC_S_AHBCONFIG(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.AHBHPROTCACHEABLE = RM_Field_FRC_S_AHBCONFIG_AHBHPROTCACHEABLE(self)
        self.zz_fdict['AHBHPROTCACHEABLE'] = self.AHBHPROTCACHEABLE
        self.__dict__['zz_frozen'] = True


class RM_Register_FRC_S_TRAILTXDATACTRL2(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_FRC_S_TRAILTXDATACTRL2, self).__init__(rmio, label,
            0xa8004000, 0x164,
            'TRAILTXDATACTRL2', 'FRC_S.TRAILTXDATACTRL2', 'read-write',
            u"",
            0x00000000, 0x000001FF,
            0x00001000, 0x00002000,
            0x00003000)

        self.TRAILTXBITSEN = RM_Field_FRC_S_TRAILTXDATACTRL2_TRAILTXBITSEN(self)
        self.zz_fdict['TRAILTXBITSEN'] = self.TRAILTXBITSEN
        self.TRAILTXBITS = RM_Field_FRC_S_TRAILTXDATACTRL2_TRAILTXBITS(self)
        self.zz_fdict['TRAILTXBITS'] = self.TRAILTXBITS
        self.TRAILTXBITSX2 = RM_Field_FRC_S_TRAILTXDATACTRL2_TRAILTXBITSX2(self)
