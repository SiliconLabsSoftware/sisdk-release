                                                                                   ...
                                                                                   uint32_t* returnedLength))
{
  UNUSED_VAR(offset);
  UNUSED_VAR(length);
  UNUSED_VAR(returnData);
  UNUSED_VAR(returnedLength);
...
void sli_zigbee_af_test_harness_z3_ota_server_activate_command(sl_cli_command_arg_t *arguments)
{
...
void sli_zigbee_af_test_harness_z3_ota_server_de_activate_command(sl_cli_command_arg_t *arguments)
{
