...
extern sl_rail_tx_packet_details_t previousTxAppendedInfo;
extern sl_rail_tx_packet_details_t previousTxAckAppendedInfo;

// Variables for RX
extern int32_t abortRxDelay;
extern sl_rail_scheduled_tx_config_t nextPacketTxTime;
