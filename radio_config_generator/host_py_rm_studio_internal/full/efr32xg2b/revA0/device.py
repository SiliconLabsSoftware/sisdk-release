...
Device
^^^^^^
This package provides a top-level device class, ``RM_Device_EFR32XG2BXFULL_RevA0``,
...
register I/O or in a live session with a real part.
  ...
  .. autoclass::  RM_Device_EFR32XG2BXFULL_RevA0
     :members:
     :show-inheritance:
     :inherited-members:
...
__all__ = [ 'RM_Device_EFR32XG2BXFULL_RevA0' ]
...
class RM_Device_EFR32XG2BXFULL_RevA0(Base_RM_Device):
    """
    ...
    def __init__(self, rmio=None, label='offline_rm', default_tz_access_mode=RM_TrustZone_Access_Mode.TZ_SECURE):
        ...
        super(RM_Device_EFR32XG2BXFULL_RevA0, self).__init__(rmio, label,
            'EFR32XG2BXFULL',
            RM_SVD_Info('EFR32XG2BXFULL_SEQ.svd', '0875ccd17017f5f7338be3e701671113'))
        ...
        self.HADM_NS = RM_Peripheral_HADM_NS(self.zz_rmio, self.zz_label)
        self.zz_pdict['HADM_NS'] = self.HADM_NS
        self.HADM_S = RM_Peripheral_HADM_S(self.zz_rmio, self.zz_label)
        self.zz_pdict['HADM_S'] = self.HADM_S
