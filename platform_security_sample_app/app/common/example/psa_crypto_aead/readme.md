...
Demonstrates how to perform AEAD operations (AES-CCM, AES-GCM, ChaCha20-Poly1305) using the PSA Crypto API, in a platform security SoC example with hardware acceleration on Secure Vault devices.
