...
__STATIC_INLINE void _display_mutex_acquire(void)
{
  EFM_ASSERT(osMutexAcquire(_display_mtx, osWaitForever) == osOK);
}

/* Mutex release */
__STATIC_INLINE void _display_mutex_release(void)
{
  EFM_ASSERT(osMutexRelease(_display_mtx) == osOK);
}
