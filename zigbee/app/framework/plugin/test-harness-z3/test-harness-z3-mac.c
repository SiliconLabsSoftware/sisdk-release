...
void sli_zigbee_af_test_harness_z3_beacon_beacon_req_command(sl_cli_command_arg_t *arguments)
{
...
void sli_zigbee_af_test_harness_z3_beacon_beacons_config_command(sl_cli_command_arg_t *arguments)
{
