...
local aarch64_ndk_r27d_enabled  = slc.is_provided("zigbee_aarch64_android_ndk_r27d")
...
if (isMoreThanOneArch(i386_enabled, arm32_enabled, x86_64_enabled, arm64_enabled, aarch64_cortex_a72_gcc_12_3_0_musl_enabled,
                      aarch64_ndk_r25c_enabled, aarch64_ndk_r27d_enabled, aarch64_tizen_enabled, arm7l_tizen_enabled )) then
