...
class RM_Field_MODEM_NS_CTRL3_DEVZEROTRAILTX(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CTRL3_DEVZEROTRAILTX, self).__init__(register,
            'DEVZEROTRAILTX', 'MODEM_NS.CTRL3.DEVZEROTRAILTX', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_NS_DCCOMP_DCCOMPZIFRSTEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_DCCOMP_DCCOMPZIFRSTEN, self).__init__(register,
            'DCCOMPZIFRSTEN', 'MODEM_NS.DCCOMP.DCCOMPZIFRSTEN', 'read-write',
            u"",
            9, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_NS_SRCCHF_MUFIFOSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SRCCHF_MUFIFOSEL, self).__init__(register,
            'MUFIFOSEL', 'MODEM_NS.SRCCHF.MUFIFOSEL', 'read-write',
            u"",
            8, 3)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_NS_IRCALCOEFWR_CRVWD(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_IRCALCOEFWR_CRVWD, self).__init__(register,
            'CRVWD', 'MODEM_NS.IRCALCOEFWR.CRVWD', 'read-write',
            u"",
            0, 15)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_IRCALCOEFWR_CRVWEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_IRCALCOEFWR_CRVWEN, self).__init__(register,
            'CRVWEN', 'MODEM_NS.IRCALCOEFWR.CRVWEN', 'read-write',
            u"",
            15, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_IRCALCOEFWR_CIVWD(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_IRCALCOEFWR_CIVWD, self).__init__(register,
            'CIVWD', 'MODEM_NS.IRCALCOEFWR.CIVWD', 'read-write',
            u"",
            16, 15)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_IRCALCOEFWR_CIVWEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_IRCALCOEFWR_CIVWEN, self).__init__(register,
            'CIVWEN', 'MODEM_NS.IRCALCOEFWR.CIVWEN', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_NS_CHFCTRL_CHFSWTIME(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCTRL_CHFSWTIME, self).__init__(register,
            'CHFSWTIME', 'MODEM_NS.CHFCTRL.CHFSWTIME', 'read-write',
            u"",
            5, 18)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE00_SET0CSDCOEFF0(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE00_SET0CSDCOEFF0, self).__init__(register,
            'SET0CSDCOEFF0', 'MODEM_NS.CHFCSDCOE00.SET0CSDCOEFF0', 'read-write',
            u"",
            0, 7)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE00_SET0CSDCOEFF1(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE00_SET0CSDCOEFF1, self).__init__(register,
            'SET0CSDCOEFF1', 'MODEM_NS.CHFCSDCOE00.SET0CSDCOEFF1', 'read-write',
            u"",
            7, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE00_SET0CSDCOEFF2(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE00_SET0CSDCOEFF2, self).__init__(register,
            'SET0CSDCOEFF2', 'MODEM_NS.CHFCSDCOE00.SET0CSDCOEFF2', 'read-write',
            u"",
            15, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE00_SET0CSDCOEFF3(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE00_SET0CSDCOEFF3, self).__init__(register,
            'SET0CSDCOEFF3', 'MODEM_NS.CHFCSDCOE00.SET0CSDCOEFF3', 'read-write',
            u"",
            23, 9)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE01_SET0CSDCOEFF4(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE01_SET0CSDCOEFF4, self).__init__(register,
            'SET0CSDCOEFF4', 'MODEM_NS.CHFCSDCOE01.SET0CSDCOEFF4', 'read-write',
            u"",
            0, 9)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE01_SET0CSDCOEFF5(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE01_SET0CSDCOEFF5, self).__init__(register,
            'SET0CSDCOEFF5', 'MODEM_NS.CHFCSDCOE01.SET0CSDCOEFF5', 'read-write',
            u"",
            9, 9)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE01_SET0CSDCOEFF6(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE01_SET0CSDCOEFF6, self).__init__(register,
            'SET0CSDCOEFF6', 'MODEM_NS.CHFCSDCOE01.SET0CSDCOEFF6', 'read-write',
            u"",
            18, 9)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE02_SET0CSDCOEFF7(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE02_SET0CSDCOEFF7, self).__init__(register,
            'SET0CSDCOEFF7', 'MODEM_NS.CHFCSDCOE02.SET0CSDCOEFF7', 'read-write',
            u"",
            0, 10)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE02_SET0CSDCOEFF8(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE02_SET0CSDCOEFF8, self).__init__(register,
            'SET0CSDCOEFF8', 'MODEM_NS.CHFCSDCOE02.SET0CSDCOEFF8', 'read-write',
            u"",
            10, 10)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE02_SET0CSDCOEFF9(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE02_SET0CSDCOEFF9, self).__init__(register,
            'SET0CSDCOEFF9', 'MODEM_NS.CHFCSDCOE02.SET0CSDCOEFF9', 'read-write',
            u"",
            20, 11)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE03_SET0CSDCOEFF10(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE03_SET0CSDCOEFF10, self).__init__(register,
            'SET0CSDCOEFF10', 'MODEM_NS.CHFCSDCOE03.SET0CSDCOEFF10', 'read-write',
            u"",
            0, 12)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE03_SET0CSDCOEFF11(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE03_SET0CSDCOEFF11, self).__init__(register,
            'SET0CSDCOEFF11', 'MODEM_NS.CHFCSDCOE03.SET0CSDCOEFF11', 'read-write',
            u"",
            12, 12)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE10_SET1CSDCOEFF0(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE10_SET1CSDCOEFF0, self).__init__(register,
            'SET1CSDCOEFF0', 'MODEM_NS.CHFCSDCOE10.SET1CSDCOEFF0', 'read-write',
            u"",
            0, 7)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE10_SET1CSDCOEFF1(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE10_SET1CSDCOEFF1, self).__init__(register,
            'SET1CSDCOEFF1', 'MODEM_NS.CHFCSDCOE10.SET1CSDCOEFF1', 'read-write',
            u"",
            7, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE10_SET1CSDCOEFF2(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE10_SET1CSDCOEFF2, self).__init__(register,
            'SET1CSDCOEFF2', 'MODEM_NS.CHFCSDCOE10.SET1CSDCOEFF2', 'read-write',
            u"",
            15, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE10_SET1CSDCOEFF3(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE10_SET1CSDCOEFF3, self).__init__(register,
            'SET1CSDCOEFF3', 'MODEM_NS.CHFCSDCOE10.SET1CSDCOEFF3', 'read-write',
            u"",
            23, 9)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE11_SET1CSDCOEFF4(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE11_SET1CSDCOEFF4, self).__init__(register,
            'SET1CSDCOEFF4', 'MODEM_NS.CHFCSDCOE11.SET1CSDCOEFF4', 'read-write',
            u"",
            0, 9)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE11_SET1CSDCOEFF5(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE11_SET1CSDCOEFF5, self).__init__(register,
            'SET1CSDCOEFF5', 'MODEM_NS.CHFCSDCOE11.SET1CSDCOEFF5', 'read-write',
            u"",
            9, 9)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE11_SET1CSDCOEFF6(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE11_SET1CSDCOEFF6, self).__init__(register,
            'SET1CSDCOEFF6', 'MODEM_NS.CHFCSDCOE11.SET1CSDCOEFF6', 'read-write',
            u"",
            18, 9)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE12_SET1CSDCOEFF7(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE12_SET1CSDCOEFF7, self).__init__(register,
            'SET1CSDCOEFF7', 'MODEM_NS.CHFCSDCOE12.SET1CSDCOEFF7', 'read-write',
            u"",
            0, 10)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE12_SET1CSDCOEFF8(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE12_SET1CSDCOEFF8, self).__init__(register,
            'SET1CSDCOEFF8', 'MODEM_NS.CHFCSDCOE12.SET1CSDCOEFF8', 'read-write',
            u"",
            10, 10)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE12_SET1CSDCOEFF9(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE12_SET1CSDCOEFF9, self).__init__(register,
            'SET1CSDCOEFF9', 'MODEM_NS.CHFCSDCOE12.SET1CSDCOEFF9', 'read-write',
            u"",
            20, 11)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE13_SET1CSDCOEFF10(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE13_SET1CSDCOEFF10, self).__init__(register,
            'SET1CSDCOEFF10', 'MODEM_NS.CHFCSDCOE13.SET1CSDCOEFF10', 'read-write',
            u"",
            0, 12)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE13_SET1CSDCOEFF11(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE13_SET1CSDCOEFF11, self).__init__(register,
            'SET1CSDCOEFF11', 'MODEM_NS.CHFCSDCOE13.SET1CSDCOEFF11', 'read-write',
            u"",
            12, 12)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE00S_SET0CSDCOEFF0S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE00S_SET0CSDCOEFF0S, self).__init__(register,
            'SET0CSDCOEFF0S', 'MODEM_NS.CHFCSDCOE00S.SET0CSDCOEFF0S', 'read-write',
            u"",
            0, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE00S_SET0CSDCOEFF1S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE00S_SET0CSDCOEFF1S, self).__init__(register,
            'SET0CSDCOEFF1S', 'MODEM_NS.CHFCSDCOE00S.SET0CSDCOEFF1S', 'read-write',
            u"",
            4, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE00S_SET0CSDCOEFF2S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE00S_SET0CSDCOEFF2S, self).__init__(register,
            'SET0CSDCOEFF2S', 'MODEM_NS.CHFCSDCOE00S.SET0CSDCOEFF2S', 'read-write',
            u"",
            8, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE00S_SET0CSDCOEFF3S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE00S_SET0CSDCOEFF3S, self).__init__(register,
            'SET0CSDCOEFF3S', 'MODEM_NS.CHFCSDCOE00S.SET0CSDCOEFF3S', 'read-write',
            u"",
            12, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE00S_SET0CSDCOEFF4S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE00S_SET0CSDCOEFF4S, self).__init__(register,
            'SET0CSDCOEFF4S', 'MODEM_NS.CHFCSDCOE00S.SET0CSDCOEFF4S', 'read-write',
            u"",
            17, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE00S_SET0CSDCOEFF5S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE00S_SET0CSDCOEFF5S, self).__init__(register,
            'SET0CSDCOEFF5S', 'MODEM_NS.CHFCSDCOE00S.SET0CSDCOEFF5S', 'read-write',
            u"",
            22, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE00S_SET0CSDCOEFF6S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE00S_SET0CSDCOEFF6S, self).__init__(register,
            'SET0CSDCOEFF6S', 'MODEM_NS.CHFCSDCOE00S.SET0CSDCOEFF6S', 'read-write',
            u"",
            27, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE01S_SET0CSDCOEFF7S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE01S_SET0CSDCOEFF7S, self).__init__(register,
            'SET0CSDCOEFF7S', 'MODEM_NS.CHFCSDCOE01S.SET0CSDCOEFF7S', 'read-write',
            u"",
            0, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE01S_SET0CSDCOEFF8S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE01S_SET0CSDCOEFF8S, self).__init__(register,
            'SET0CSDCOEFF8S', 'MODEM_NS.CHFCSDCOE01S.SET0CSDCOEFF8S', 'read-write',
            u"",
            5, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE01S_SET0CSDCOEFF9S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE01S_SET0CSDCOEFF9S, self).__init__(register,
            'SET0CSDCOEFF9S', 'MODEM_NS.CHFCSDCOE01S.SET0CSDCOEFF9S', 'read-write',
            u"",
            10, 6)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE01S_SET0CSDCOEFF10S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE01S_SET0CSDCOEFF10S, self).__init__(register,
            'SET0CSDCOEFF10S', 'MODEM_NS.CHFCSDCOE01S.SET0CSDCOEFF10S', 'read-write',
            u"",
            16, 6)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE01S_SET0CSDCOEFF11S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE01S_SET0CSDCOEFF11S, self).__init__(register,
            'SET0CSDCOEFF11S', 'MODEM_NS.CHFCSDCOE01S.SET0CSDCOEFF11S', 'read-write',
            u"",
            22, 6)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE10S_SET1CSDCOEFF0S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE10S_SET1CSDCOEFF0S, self).__init__(register,
            'SET1CSDCOEFF0S', 'MODEM_NS.CHFCSDCOE10S.SET1CSDCOEFF0S', 'read-write',
            u"",
            0, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE10S_SET1CSDCOEFF1S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE10S_SET1CSDCOEFF1S, self).__init__(register,
            'SET1CSDCOEFF1S', 'MODEM_NS.CHFCSDCOE10S.SET1CSDCOEFF1S', 'read-write',
            u"",
            4, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE10S_SET1CSDCOEFF2S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE10S_SET1CSDCOEFF2S, self).__init__(register,
            'SET1CSDCOEFF2S', 'MODEM_NS.CHFCSDCOE10S.SET1CSDCOEFF2S', 'read-write',
            u"",
            8, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE10S_SET1CSDCOEFF3S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE10S_SET1CSDCOEFF3S, self).__init__(register,
            'SET1CSDCOEFF3S', 'MODEM_NS.CHFCSDCOE10S.SET1CSDCOEFF3S', 'read-write',
            u"",
            12, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE10S_SET1CSDCOEFF4S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE10S_SET1CSDCOEFF4S, self).__init__(register,
            'SET1CSDCOEFF4S', 'MODEM_NS.CHFCSDCOE10S.SET1CSDCOEFF4S', 'read-write',
            u"",
            17, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE10S_SET1CSDCOEFF5S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE10S_SET1CSDCOEFF5S, self).__init__(register,
            'SET1CSDCOEFF5S', 'MODEM_NS.CHFCSDCOE10S.SET1CSDCOEFF5S', 'read-write',
            u"",
            22, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE10S_SET1CSDCOEFF6S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE10S_SET1CSDCOEFF6S, self).__init__(register,
            'SET1CSDCOEFF6S', 'MODEM_NS.CHFCSDCOE10S.SET1CSDCOEFF6S', 'read-write',
            u"",
            27, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE11S_SET1CSDCOEFF7S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE11S_SET1CSDCOEFF7S, self).__init__(register,
            'SET1CSDCOEFF7S', 'MODEM_NS.CHFCSDCOE11S.SET1CSDCOEFF7S', 'read-write',
            u"",
            0, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE11S_SET1CSDCOEFF8S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE11S_SET1CSDCOEFF8S, self).__init__(register,
            'SET1CSDCOEFF8S', 'MODEM_NS.CHFCSDCOE11S.SET1CSDCOEFF8S', 'read-write',
            u"",
            5, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE11S_SET1CSDCOEFF9S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE11S_SET1CSDCOEFF9S, self).__init__(register,
            'SET1CSDCOEFF9S', 'MODEM_NS.CHFCSDCOE11S.SET1CSDCOEFF9S', 'read-write',
            u"",
            10, 6)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE11S_SET1CSDCOEFF10S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE11S_SET1CSDCOEFF10S, self).__init__(register,
            'SET1CSDCOEFF10S', 'MODEM_NS.CHFCSDCOE11S.SET1CSDCOEFF10S', 'read-write',
            u"",
            16, 6)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE11S_SET1CSDCOEFF11S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE11S_SET1CSDCOEFF11S, self).__init__(register,
            'SET1CSDCOEFF11S', 'MODEM_NS.CHFCSDCOE11S.SET1CSDCOEFF11S', 'read-write',
            u"",
            22, 6)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE00NADM_NADMCSDCOEFF0(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE00NADM_NADMCSDCOEFF0, self).__init__(register,
            'NADMCSDCOEFF0', 'MODEM_NS.CHFCSDCOE00NADM.NADMCSDCOEFF0', 'read-write',
            u"",
            0, 7)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE00NADM_NADMCSDCOEFF1(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE00NADM_NADMCSDCOEFF1, self).__init__(register,
            'NADMCSDCOEFF1', 'MODEM_NS.CHFCSDCOE00NADM.NADMCSDCOEFF1', 'read-write',
            u"",
            7, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE00NADM_NADMCSDCOEFF2(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE00NADM_NADMCSDCOEFF2, self).__init__(register,
            'NADMCSDCOEFF2', 'MODEM_NS.CHFCSDCOE00NADM.NADMCSDCOEFF2', 'read-write',
            u"",
            15, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE00NADM_NADMCSDCOEFF3(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE00NADM_NADMCSDCOEFF3, self).__init__(register,
            'NADMCSDCOEFF3', 'MODEM_NS.CHFCSDCOE00NADM.NADMCSDCOEFF3', 'read-write',
            u"",
            23, 9)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE01NADM_NADMCSDCOEFF4(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE01NADM_NADMCSDCOEFF4, self).__init__(register,
            'NADMCSDCOEFF4', 'MODEM_NS.CHFCSDCOE01NADM.NADMCSDCOEFF4', 'read-write',
            u"",
            0, 9)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE01NADM_NADMCSDCOEFF5(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE01NADM_NADMCSDCOEFF5, self).__init__(register,
            'NADMCSDCOEFF5', 'MODEM_NS.CHFCSDCOE01NADM.NADMCSDCOEFF5', 'read-write',
            u"",
            9, 9)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE01NADM_NADMCSDCOEFF6(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE01NADM_NADMCSDCOEFF6, self).__init__(register,
            'NADMCSDCOEFF6', 'MODEM_NS.CHFCSDCOE01NADM.NADMCSDCOEFF6', 'read-write',
            u"",
            18, 9)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE02NADM_NADMCSDCOEFF7(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE02NADM_NADMCSDCOEFF7, self).__init__(register,
            'NADMCSDCOEFF7', 'MODEM_NS.CHFCSDCOE02NADM.NADMCSDCOEFF7', 'read-write',
            u"",
            0, 10)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE02NADM_NADMCSDCOEFF8(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE02NADM_NADMCSDCOEFF8, self).__init__(register,
            'NADMCSDCOEFF8', 'MODEM_NS.CHFCSDCOE02NADM.NADMCSDCOEFF8', 'read-write',
            u"",
            10, 10)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE02NADM_NADMCSDCOEFF9(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE02NADM_NADMCSDCOEFF9, self).__init__(register,
            'NADMCSDCOEFF9', 'MODEM_NS.CHFCSDCOE02NADM.NADMCSDCOEFF9', 'read-write',
            u"",
            20, 11)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE03NADM_NADMCSDCOEFF10(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE03NADM_NADMCSDCOEFF10, self).__init__(register,
            'NADMCSDCOEFF10', 'MODEM_NS.CHFCSDCOE03NADM.NADMCSDCOEFF10', 'read-write',
            u"",
            0, 12)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE03NADM_NADMCSDCOEFF11(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE03NADM_NADMCSDCOEFF11, self).__init__(register,
            'NADMCSDCOEFF11', 'MODEM_NS.CHFCSDCOE03NADM.NADMCSDCOEFF11', 'read-write',
            u"",
            12, 12)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE00SNADM_NADMCSDCOEFF0S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE00SNADM_NADMCSDCOEFF0S, self).__init__(register,
            'NADMCSDCOEFF0S', 'MODEM_NS.CHFCSDCOE00SNADM.NADMCSDCOEFF0S', 'read-write',
            u"",
            0, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE00SNADM_NADMCSDCOEFF1S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE00SNADM_NADMCSDCOEFF1S, self).__init__(register,
            'NADMCSDCOEFF1S', 'MODEM_NS.CHFCSDCOE00SNADM.NADMCSDCOEFF1S', 'read-write',
            u"",
            4, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE00SNADM_NADMCSDCOEFF2S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE00SNADM_NADMCSDCOEFF2S, self).__init__(register,
            'NADMCSDCOEFF2S', 'MODEM_NS.CHFCSDCOE00SNADM.NADMCSDCOEFF2S', 'read-write',
            u"",
            8, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE00SNADM_NADMCSDCOEFF3S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE00SNADM_NADMCSDCOEFF3S, self).__init__(register,
            'NADMCSDCOEFF3S', 'MODEM_NS.CHFCSDCOE00SNADM.NADMCSDCOEFF3S', 'read-write',
            u"",
            12, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE00SNADM_NADMCSDCOEFF4S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE00SNADM_NADMCSDCOEFF4S, self).__init__(register,
            'NADMCSDCOEFF4S', 'MODEM_NS.CHFCSDCOE00SNADM.NADMCSDCOEFF4S', 'read-write',
            u"",
            17, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE00SNADM_NADMCSDCOEFF5S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE00SNADM_NADMCSDCOEFF5S, self).__init__(register,
            'NADMCSDCOEFF5S', 'MODEM_NS.CHFCSDCOE00SNADM.NADMCSDCOEFF5S', 'read-write',
            u"",
            22, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE00SNADM_NADMCSDCOEFF6S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE00SNADM_NADMCSDCOEFF6S, self).__init__(register,
            'NADMCSDCOEFF6S', 'MODEM_NS.CHFCSDCOE00SNADM.NADMCSDCOEFF6S', 'read-write',
            u"",
            27, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE01SNADM_NADMCSDCOEFF7S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE01SNADM_NADMCSDCOEFF7S, self).__init__(register,
            'NADMCSDCOEFF7S', 'MODEM_NS.CHFCSDCOE01SNADM.NADMCSDCOEFF7S', 'read-write',
            u"",
            0, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE01SNADM_NADMCSDCOEFF8S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE01SNADM_NADMCSDCOEFF8S, self).__init__(register,
            'NADMCSDCOEFF8S', 'MODEM_NS.CHFCSDCOE01SNADM.NADMCSDCOEFF8S', 'read-write',
            u"",
            5, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE01SNADM_NADMCSDCOEFF9S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE01SNADM_NADMCSDCOEFF9S, self).__init__(register,
            'NADMCSDCOEFF9S', 'MODEM_NS.CHFCSDCOE01SNADM.NADMCSDCOEFF9S', 'read-write',
            u"",
            10, 6)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE01SNADM_NADMCSDCOEFF10S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE01SNADM_NADMCSDCOEFF10S, self).__init__(register,
            'NADMCSDCOEFF10S', 'MODEM_NS.CHFCSDCOE01SNADM.NADMCSDCOEFF10S', 'read-write',
            u"",
            16, 6)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CHFCSDCOE01SNADM_NADMCSDCOEFF11S(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CHFCSDCOE01SNADM_NADMCSDCOEFF11S, self).__init__(register,
            'NADMCSDCOEFF11S', 'MODEM_NS.CHFCSDCOE01SNADM.NADMCSDCOEFF11S', 'read-write',
            u"",
            22, 6)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_UCHDR_UCHDREN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_UCHDR_UCHDREN, self).__init__(register,
            'UCHDREN', 'MODEM_NS.UCHDR.UCHDREN', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_UCHDR_UCHDRBITS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_UCHDR_UCHDRBITS, self).__init__(register,
            'UCHDRBITS', 'MODEM_NS.UCHDR.UCHDRBITS', 'read-write',
            u"",
            1, 9)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_UCHDR_UCHDRBITSX2(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_UCHDR_UCHDRBITSX2, self).__init__(register,
            'UCHDRBITSX2', 'MODEM_NS.UCHDR.UCHDRBITSX2', 'read-write',
            u"",
            10, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_UCHDR_UCHDRBAUD(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_UCHDR_UCHDRBAUD, self).__init__(register,
            'UCHDRBAUD', 'MODEM_NS.UCHDR.UCHDRBAUD', 'read-write',
            u"",
            11, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_RAMPAUTO_RAMPDOWNAUTO(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_RAMPAUTO_RAMPDOWNAUTO, self).__init__(register,
            'RAMPDOWNAUTO', 'MODEM_NS.RAMPAUTO.RAMPDOWNAUTO', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_RAMPAUTO_RAMPDOWNTIMER(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_RAMPAUTO_RAMPDOWNTIMER, self).__init__(register,
            'RAMPDOWNTIMER', 'MODEM_NS.RAMPAUTO.RAMPDOWNTIMER', 'read-write',
            u"",
            1, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_RAMPHADM_RAMPLEVHADM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_RAMPHADM_RAMPLEVHADM, self).__init__(register,
            'RAMPLEVHADM', 'MODEM_NS.RAMPHADM.RAMPLEVHADM', 'read-write',
            u"",
            0, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_RAMPHADM_RAMPRATEHADM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_RAMPHADM_RAMPRATEHADM, self).__init__(register,
            'RAMPRATEHADM', 'MODEM_NS.RAMPHADM.RAMPRATEHADM', 'read-write',
            u"",
            8, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_RAMPHADM_RAMPENHADM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_RAMPHADM_RAMPENHADM, self).__init__(register,
            'RAMPENHADM', 'MODEM_NS.RAMPHADM.RAMPENHADM', 'read-write',
            u"",
            12, 1)
        self.__dict__['zz_frozen'] = True
